...
const ContactUs = () => {
    ...
    return (
        <section id='contact' className="py-6 pt-28 bg-[#070D1B]">
            <h2 className="text-4xl font-bold text-center text-white mb-8">Contact Us</h2>
            <div className="grid max-w-6xl grid-cols-1  px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
                <Fade direction='left' triggerOnce>
                    <div className="py-6 md:py-0 md:px-6">
                        <h1 className="text-4xl font-bold text-white">Let’s Discuss Your Project</h1>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <a
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    href="https://mail.google.com/mail/?view=cm&fs=1&to=majidul123tub@gmail.com" className='text-gray-400 md:text-xl hover:text-orange-300'>majidul123tub@gamil.com</a>
                            </div>
                        </div>
                    </div>
                </Fade>
                ...
                <Fade direction='right' triggerOnce>
                    <form ref={form} onSubmit={sendEmail} className="container w-full max-w-xl md:p-8 mx-auto space-y-6 rounded-md shadow ">
                        <p className="text-4xl text-white font-bold">Send me A message</p>
                        <div>
                            <label className="block text-white mb-1 ml-1">Name</label>
                        ...
                        <div>
                            <label className="block text-white mb-1 ml-1">Email</label>
                        ...
                        <div>
                            <label className="block text-white mb-1 ml-1">Message</label>
